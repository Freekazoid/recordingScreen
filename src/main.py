...
# TorchScript требует исходники модулей, которых нет в заморозке
# (PyInstaller): NeMo падал на @torch.jit.script при импорте.
# Отключаем JIT — декорированные функции работают в обычном режиме eager.
